...
class KotakSecurityClient {
	...
	constructor(opts: IOption) {
		if (!opts) throw new Error('Options Not Found');

		if (opts.userId != null && typeof opts.userId == 'string') this.userId = opts.userId;
		else throw new Error('userId not found');
		if (opts.password != null && typeof opts.password == 'string') this.password = opts.password;
		else throw new Error('password not found');
		if (opts.appId != null && typeof opts.appId == 'string') this.appId = opts.appId;
		else throw new Error('appId not found');
		if (opts.consumerKey != null && typeof opts.consumerKey == 'string') this.consumerKey = opts.consumerKey;
		else throw new Error('consumerKey not found');
		if (opts.secretKey != null && typeof opts.secretKey == 'string') this.secretKey = opts.secretKey;
		else throw new Error('secretKey not found');
		if (opts.accessCode != null && typeof opts.accessCode == 'string') this.accessCode = opts.accessCode;
		else throw new Error('accessCode not found');
	}
